...
const transporter = nodemailer.createTransport({
    ...
    auth: {
      user:'career@skillmate.ai',
    pass: 'C@r33r7@#123@#1243',    // Your email password or App password
    }
});
...
router.post("/send/looking", async function (req, res, next) {
    ...
    try {
      ...
      //   }
      // };
      const htmlContent1 = await ejs.renderFile(templatePath, { fullname, service });
...
router.post("/send/notnow", async function (req, res, next) {
    ...
    try {
      ...
      const htmlContent1 = await ejs.renderFile(templatePath, { fullname, feedback });
